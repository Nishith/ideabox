...
Devise.setup do |config|
  ...
  # config.pepper = "250330165e34ab10de1c980c84e2cddfb325d49973ca355f2c119d809d4a7d7f78abb4f0cad6d0024546db58b33be5ae19c83fbade5adf5f534e912459bf2a85"

  # ==> Configuration for :confirmable
  # The time you want to give your users to confirm his account. During this time
  # he will be able to access your application without confirming. Default is 0.days
  # When confirm_within is zero, the users won't be able to sign in without confirming.
  # You can use this to let your users access some features of your application
  ...
  # If true, authentication through token does not store users in session and needs
  ...
  # Sign_out action can be scoped (i.e. /users/sign_out affects only :users scope).
